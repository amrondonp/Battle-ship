...
public class Utilities {
  ...
  public static boolean isOne() {
    if (
      SimpleClientController.getInstance().getClient().getId() == 0
  ...
  public static Player me() {
    if (isOne()) return Controller
      .getInstance()
      .getTheModel()
      .getOne(); else return Controller.getInstance().getTheModel().getTwo();
  }
  ...
  public static int getRandomFlag(double probability) {
    if (Math.random() < probability) return 1; else return 0;
  }
