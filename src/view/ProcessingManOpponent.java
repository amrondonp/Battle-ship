...
public class ProcessingManOpponent extends PApplet {
   ...
   */
  public void draw() {
    if (aux) image(image, point.x * 50, point.y * 50, 50, 50);
  }
  ...
  public Field getField() {
    if (Utilities.isOne()) return Controller
      .getTheOnlyInstance()
      .getTheModel()
      .getOne()
      .getField(); else return Controller
      .getTheOnlyInstance()
      .getTheModel()
      .getTwo()
      .getField();
  ...
  public static Field getTheOtherField() {
    Field aux;
    if (Utilities.isOne()) aux =
      Controller
        .getTheOnlyInstance()
        .getTheModel()
        .getTwo()
        .getField(); else aux =
      Controller.getTheOnlyInstance().getTheModel().getOne().getField();
  ...
  public void mousePressed() {
    aux = false;
    FramePlayerMan framePlayer = Controller
      .getTheOnlyInstance()
      .getTheView()
      .getFramePlayerMan();
    FrameManOpponent frameManOpponent = Controller
      .getTheOnlyInstance()
      .getTheView()
      .getFrameManOpponent();
    if (mouseButton == LEFT) {
      if (
        Controller.getInstance().getTheModel().getTurn() !=
        Utilities.me().getID()
      ) {
        JOptionPane.showMessageDialog(
          Controller.getInstance().getTheView().getFrameManOpponent(),
          "No es tu turno"
        );
        return;
      }
