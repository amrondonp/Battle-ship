...
public class ProcessingOpponent extends PApplet {
  ...
  public void mousePressed() {
    aux = false;
    Field fieldCPU = Controller
      .getTheOnlyInstance()
      .getTheModel()
      .getTwo()
      .getField();
    Field fieldMan = Controller
      .getTheOnlyInstance()
      .getTheModel()
      .getOne()
      .getField();
    ProcessingPlayer processingPlayer = Controller
      .getTheOnlyInstance()
      .getTheView()
      .getFramePlayer()
      .getSketch();
    FramePlayerMan framePlayer = Controller
      ...
      .getTheView()
      .getFramePlayerMan();
    FrameOpponent frameOpponent = Controller
      .getTheOnlyInstance()
      .getTheView()
      .getFrameOpponent();
    if (mouseButton == LEFT) {
