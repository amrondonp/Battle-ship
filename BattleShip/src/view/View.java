package view;
/**
 * Class contains all relevant to the View of the program, Class View of the MVC pattern 
...
public class View {
	 ...
	 */
	public View(FramePlayer framePlayer, FrameOpponent frameOpponent,FrameHome frameHome, FrameManOpponent frameManOpponent,FramePlayerMan framePlayerMan ) {
		super();
		this.framePlayer = framePlayer;
		this.frameOpponent = frameOpponent;
